...
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <header className="w-full bg-[#FFE600] border-b-4 border-black p-4 sm:p-5 md:p-6 shadow-[0px_4px_0px_0px_#000]">
      <div className="max-w-7xl mx-auto space-y-4 md:space-y-5">
        {/* Top Title & Action Buttons */}
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            <div className="bg-black text-[#FFE600] p-2.5 border-2 border-black shadow-[3px_3px_0px_0px_#FFF] shrink-0">
          ...
          <div className="flex flex-wrap items-center gap-2 sm:gap-3 shrink-0">
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="neo-btn bg-[#06B6D4] text-black font-black px-3 py-2 text-xs min-h-[44px] flex items-center gap-1.5 uppercase hover:bg-[#38BDF8]"
            >
            ...
            <button
              ...
              disabled={isLoading}
              className="neo-btn bg-[#A855F7] text-white font-black px-3 py-2 text-xs min-h-[44px] flex items-center gap-1.5 uppercase hover:bg-[#C084FC] disabled:opacity-50"
        ...
        <form onSubmit={handleSubmit} className="w-full max-w-3xl">
          <div className="flex flex-col sm:flex-row items-stretch gap-2.5">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="neo-btn bg-[#FF007A] text-white font-black px-6 py-3 min-h-[48px] text-sm md:text-base flex items-center justify-center gap-2 uppercase whitespace-nowrap disabled:opacity-50"
            >
